  ...
  return (
    <div style={{ background: 'var(--surface)', border: '2px solid var(--line)', borderRadius: '12px', padding: '8px', display: 'flex', justifyContent: 'center' }}>
      <svg width="320" height="320" viewBox="0 0 400 400">
        ...
        <text x="13" y="35" fill="var(--sea-ink-soft)" fontSize="26" fontWeight="bold">9</text>
        <text x="387" y="35" textAnchor="end" fill="var(--sea-ink-soft)" fontSize="26" fontWeight="bold">10</text>
        <text x="108" y="135" fill="var(--sea-ink-soft)" fontSize="26" fontWeight="bold">11</text>
        <text x="292" y="135" textAnchor="end" fill="var(--sea-ink-soft)" fontSize="26" fontWeight="bold">12</text>
