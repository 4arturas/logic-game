  ...
  return (
    <div style={{ background: 'var(--surface)', border: '2px solid var(--line)', borderRadius: '12px', padding: '8px', display: 'flex', justifyContent: 'center' }}>
      <svg width="320" height="320" viewBox="0 0 400 400">
        ...
        <text x="13" y="40" fill="var(--sea-ink-soft)" fontSize="26" fontWeight="bold">9</text>
        <text x="387" y="40" textAnchor="end" fill="var(--sea-ink-soft)" fontSize="26" fontWeight="bold">10</text>
        <text x="108" y="140" fill="var(--sea-ink-soft)" fontSize="26" fontWeight="bold">11</text>
        <text x="292" y="140" textAnchor="end" fill="var(--sea-ink-soft)" fontSize="26" fontWeight="bold">12</text>
