  ...
  var counters = Object.keys(state).map(function(id) {
    ...
    return (
      <g key={id} className="pointer-events-none select-none">
        ...
        <text x={cell.cx} y={cell.cy + radius / 3} textAnchor="middle" fill="white" fontSize="18" fontWeight="bold">
          {st === 'red' ? '1' : '0'}
        </text>
      </g>
    );
  ...
  return (
    <div style={{ background: 'var(--surface)', border: '2px solid var(--line)', borderRadius: '12px', padding: '8px', display: 'flex', justifyContent: 'center' }}>
      <svg width="320" height="320" viewBox="0 0 400 400">
        ...
        <text x="13" y="21" fill="var(--sea-ink-soft)" fontSize="26" fontWeight="bold">9</text>
        <text x="387" y="21" textAnchor="end" fill="var(--sea-ink-soft)" fontSize="26" fontWeight="bold">10</text>
        <text x="108" y="117" fill="var(--sea-ink-soft)" fontSize="26" fontWeight="bold">11</text>
        <text x="292" y="117" textAnchor="end" fill="var(--sea-ink-soft)" fontSize="26" fontWeight="bold">12</text>
        ...
        <text x="387" y="387" textAnchor="end" fill="var(--sea-ink-soft)" fontSize="26" fontWeight="bold">16</text>
        <text x="200" y="85" textAnchor="middle" fill="var(--term-x)" fontSize="30" fontWeight="bold" fontFamily="serif" fontStyle="italic">{t(minorTerm)}</text>
        <text x="200" y="335" textAnchor="middle" fill="var(--term-x)" fontSize="30" fontWeight="bold" fontFamily="serif" fontStyle="italic">{t(minorTerm)}'</text>
        <text x="50" y="210" textAnchor="middle" fill="var(--term-y)" fontSize="30" fontWeight="bold" fontFamily="serif" fontStyle="italic" transform="rotate(-90 50 210)">{t(majorTerm)}</text>
        <text x="350" y="210" textAnchor="middle" fill="var(--term-y)" fontSize="30" fontWeight="bold" fontFamily="serif" fontStyle="italic" transform="rotate(-90 350 210)">{t(majorTerm)}'</text>
        <text x="200" y="210" textAnchor="middle" fill="var(--term-m)" fontSize="30" fontWeight="bold" fontFamily="serif" fontStyle="italic">{t(middleTerm)}</text>
